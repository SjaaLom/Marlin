...
#define STRING_CONFIG_H_AUTHOR "(sjaalom, Ender-3)" // Who made the changes.
...
//#error "NOZZLE_TO_PROBE_OFFSET is not measured yet. Please define it in Configuration.h"
